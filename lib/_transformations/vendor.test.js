...
import { vendorSpecifiers } from "./vendor.js";
test(function vendoring() {
    ...
    const file = project.createSourceFile("src/deps.deno.ts", 'export * from "https://deno.land/x/ts_morph/mod.ts"', { overwrite: true });
    const exportDeclaration = file.getChildrenOfKind(ts.SyntaxKind.ExportDeclaration)[0];
